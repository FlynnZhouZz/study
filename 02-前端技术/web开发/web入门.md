...
[Node 官网](https://nodejs.org/zh-cn)<br>
...
> 搜索引擎是帮助你查找其他网页的网络服务，例如 Google、Bing、Yahoo、DuckDuckGo 或百度。通常通过 Web 浏览器（例如，你可以直接在 Firefox、Chrome 等浏览器的地址栏中进行搜索引擎搜索）或通过网页（例如 bing.com 或 duckduckgo.com）访问搜索引擎。
